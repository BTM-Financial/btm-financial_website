...
$id = $_REQUEST['id'];
	...
	$sqlDelete = $db->execute("DELETE FROM `success_stories` WHERE `id` = '$id'");
	if($sqlDelete==true):
...
$status = $_REQUEST['status'];
	...
	$sqlStatus = $db->execute("UPDATE `success_stories` SET `status` = '$status' WHERE `id` = '$id'");
}
...
<head>
    ...
    <title><?= $websiteTitle; ?> | View Success Stories</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1> <a href="add-success-stories.php" class="btn btn-sm btn-info btn-flat">Add Success Stories</a></h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">View Success Stories</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
				  	...
				  	$i=1;
					$query = $db->getAllData("SELECT * FROM `success_stories` ORDER BY `id` DESC");
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="add-success-stories.php?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a> 
                    || 
