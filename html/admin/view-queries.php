...
$id = $_REQUEST['id'];
	...
	$sqlDelete = $db->execute("DELETE FROM `queries` WHERE `query_id` = '$id'");
	if($sqlDelete==true):
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1> Manage Queries <small>View Queries</small> </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">View Queries</h3>
            </div>
            <div class="box-body">
              <?php if(isset($msg)){ ?>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
				  	...
				  	$i=1;
					$cateogryQuery = $db->getAllData("SELECT * FROM `queries` ORDER BY `query_id` DESC");
