...
$id = $_REQUEST['id'];
	...
	$sqlDelete = $db->execute("DELETE FROM `why_chooses` WHERE `id` = '$id'");
	if($sqlDelete==true):
...
$status = $_REQUEST['status'];
	...
	$sqlStatus = $db->execute("UPDATE `why_chooses` SET `status` = '$status' WHERE `id` = '$id'");
}
...
<head>
    ...
    <title><?= $websiteTitle; ?> | View Why Choose Us</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1> <a href="add-why-choose.php" class="btn btn-sm btn-info btn-flat">Add Why Choose Us</a></h1>
      <ol class="breadcrumb">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
				  	...
				  	$i=1;
					$query = $db->getAllData("SELECT * FROM `why_chooses` ORDER BY `id` DESC");
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="add-why-choose.php?id=<?php echo base64_encode($row['id']); ?>"><i class="fa fa-edit"></i></a> 
                    || 
