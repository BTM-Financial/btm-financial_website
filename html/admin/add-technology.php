...
$editval = $db->getData("SELECT * FROM `technologies` WHERE `id` = '$id'");
}else{
  $id = '';
}
...
if(isset($_REQUEST['submit'])){
	...
	$result = $db->execute("INSERT INTO `technologies`(`title`, `description`, `status`, `created_at`) VALUES ('$title', '$description', '$status', NOW())");
...
if(isset($_REQUEST['update'])){
	...
	$result = $db->execute("UPDATE `technologies` SET `title` = '$title', `description` = '$description', `status` = '$status', `updated_at` = NOW() WHERE `id` = '$id'");
...
<head>
    ...
    <title><?= $websiteTitle; ?> | Add Technology Stack</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Technology Stack</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-warning">
            <div class="box-header with-border">
              <?php if(empty($id)): ?>
              <h3 class="box-title">Add Technology Stack</h3>
              <?php else: ?>
              <h3 class="box-title">Update Technology Stack</h3>
              <?php endif; ?>
            </div>
            <div class="box-body">
                <?php if(isset($msg)){ ?>
              ...
              <form name="mybanner" id="mybanner" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <textarea name="description" id="editor1" class="form-control" rows="10" cols="10"></textarea>
              ...
              <form name="mybanner" id="mybanner" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="inputExperience" class="col-sm-2 control-label">Description</label>
                    <div class="col-sm-6">
                    <textarea name="description" id="editor1" class="form-control" rows="10" cols="10"><?php echo $editval['description']; ?></textarea>  
                    </div>
                </div>
