...
$editval = $db->getData("SELECT * FROM `pages` WHERE `page_id` = '3'");
// update record query
if(isset($_REQUEST['update'])){
	$page_name = 'We Aim For The Stars';
	...
	$result = $db->execute("UPDATE `pages` SET `page_title` = '$page_title', `page_detail` = '$page_detail', `image` = '$image', `meta_title` = '$meta_title', `meta_description` = '$meta_description', `meta_keyword` = '$meta_keyword', `is_active` = '$status', `modified_by` = '".$_SESSION['ADMIN_USER_ID']."', `modified_at` = NOW() WHERE `page_id` = '3'");

	if($result===true){
		move_uploaded_file($imagetmp,$dest);
    $msg = 'Page has been updated successfully ..';
		header("Location:add-we-aim.php");
	} else {
...
<head>
    ...
    <title><?= $websiteTitle; ?> | Add We Aim For The Stars</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1> We Aim For The Stars</h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">We Aim For The Stars</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">We Aim For The Stars</h3>
            </div>
            <div class="box-body">
                <?php if(isset($msg)){ ?>
