...
$id = $_REQUEST['id'];
	...
	$sqlDelete = $db->execute("DELETE FROM `banners` WHERE `id` = '$id'");
	if($sqlDelete==true):
...
$status = $_REQUEST['status'];
	...
	$sqlStatus = $db->execute("UPDATE `banners` SET `status` = '$status' WHERE `id` = '$id'");
}
...
<head>
    ...
    <title><?= $websiteTitle; ?> | View Banners</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1> <a href="add-banner.php" class="btn btn-sm btn-info btn-flat">Add Banner</a></h1>
      <ol class="breadcrumb">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="../uploads/banners/<?php echo $row['image']; ?>" height="100" width="100" /></td>
