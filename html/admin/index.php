...
if(isset($_REQUEST['btn_login']) && $_REQUEST['btn_login'] == 'Sign In')
{
  ...
  $pass = $db->addStr(md5($_POST['password']));
...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="<?php echo $websiteUrl; ?>admin/bower_components/bootstrap/dist/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo $websiteUrl; ?>admin/bower_components/font-awesome/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo $websiteUrl; ?>admin/bower_components/Ionicons/css/ionicons.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo $websiteUrl; ?>admin/dist/css/AdminLTE.min.css">
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo $websiteUrl; ?>/admin/plugins/iCheck/square/blue.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
</head>
<body class="hold-transition login-page">
<div class="login-box">
  <div class="login-logo"><h2><a href="<?php echo $websiteUrl; ?>"><?php echo $websiteTitle; ?></a></h2></div>
